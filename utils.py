...
def check_directories(args):
    ...
    if not os.path.exists(cache_path):
        # makedirs (not mkdir) so the parent input_dir (e.g. 'assets/') is created too.
        # A fresh checkout has no assets/ dir -- git and tar do not preserve empty dirs --
        # and plain os.mkdir('assets/cache') would FileNotFoundError on the missing parent.
