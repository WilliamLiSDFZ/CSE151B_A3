...
def check_cache(args):
    folder = 'cache'
    # Cache key includes max_len because it is baked into the tokenized features;
    # otherwise changing --max-len would silently reuse stale features.
    cache_path = os.path.join(args.input_dir, folder, f'{args.dataset}_len{args.max_len}.pkl')
